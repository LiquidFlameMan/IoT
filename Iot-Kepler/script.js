...
function getCollisions(){
  const possibleCollisions = [{lat: 59.9419, lng: 30.2989, name: 'Глеб Сумбатян', confirmed: false, time: '17:30:30'}, {lat: 59.93391, lng: 30.30647, name: 'Иван Галимов',
  confirmed: false, time: '17:30:30', },];
